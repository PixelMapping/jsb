    ...
    render() {
        ...
        return (
            ...
            >
                <Form {...formItemLayout}>
                    <FormItem label="预交税金">
                        {getFieldDecorator('prepaidTax', {
                            rules: [{ required: true, message: '请输入预交税金' }],
                        })(
                            <Input placeholder="请输入预交税金" />
                        )}
                    </FormItem>
                    <FormItem label="预交税金率">
                        {getFieldDecorator('taxPreRate', {
                            rules: [{ required: true, message: '请输入预交税金率' }],
                        })(
                            <Input placeholder="请输入预交税金率" />
                        )}
                    </FormItem>
                </Form>
